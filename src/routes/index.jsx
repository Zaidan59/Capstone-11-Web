...
import NotificationSekolah from '../pages/Notification/NotificationSekolah'  // ← BARU
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          {/* Notification Sekolah — outside Layout, pakai navbar dashboard sendiri */}
          <Route path="/notification/sekolah" element={<NotificationSekolah />} />  {/* ← BARU */}
        </Route>
