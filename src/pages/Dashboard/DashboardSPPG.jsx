      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-xl border border-gray-200 flex flex-col md:flex-row justify-between items-center gap-8 shadow-sm">
          ...
          <div className="flex items-center flex-shrink-0">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-medium flex items-center gap-2 transition-all active:scale-95 whitespace-nowrap">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="flex flex-col justify-center gap-5 w-full md:w-1/2">
                ...
                <div className="rounded-xl p-5 space-y-3" style={{ 
                  backgroundColor: '#136DEC0D',  
                  border: '1px solid #136DEC1A'  
                }}>
              ...
              <div className="flex flex-col md:flex-row gap-8">
               ...
               {/* Left: Add Photo */}
                ...
                {/* Right: Form Fields */}
                  ...
                  {/* Row: Preparation Date + Target School */}
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      placeholder="e.g. Fresh portion delivered to SDN 01"
                      rows={3}
